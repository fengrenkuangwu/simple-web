...
public class NumberUtil {
	 ...
	 * <p/>
	 * <p/>
	 * 该参数被解释为表示一个有符号的十进制 long，该值与用该参数作为参数的 parseLong(java.lang.String)
	 * 方法得到的值非常相似。
	 * <p/>
	 * <p/>
	 * 只是最后被转换为一个Long的包装类。
	 ...
	 * <p/>
	 * doubleValueOf.doubleValueOf(String) ,参数String表示，指定 String 的值的
	 * doubleValueOf 对象。
	 * <p/>
	 * <p/>
	 * 该参数被解释为表示一个有符号的十进制 long，该值与用该参数作为参数的 parseLong(java.lang.String)
	 ...
	 * @param a
	 *            , b俩long值； bigFlg：true-获取大值；false-获取小值
	 * @return 或大或小的值
	 */
