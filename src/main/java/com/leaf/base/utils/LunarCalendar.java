...
public class LunarCalendar {
    ...
    public static void main(String[] args){
     ...
     //加载自定义日期
     //today.setTime(chineseDateFormat.parse("2006年10月30日"));
     ...
     //计算输出星期几
     System.out.println("星期" + lunar.getChinaWeekdayString(today.getTime().toString().substring(0, 3)));
    }
}
