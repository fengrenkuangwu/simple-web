...
public final class DateUtil {
	 ...
	 * @throws ParseException
	 */
	public static Date toDateYcrm(String dateStr) throws ParseException {
	...
	/**
	 * 比较两个日期的大小 <p/> <pre> 1、日期参数为空表示无穷小 </pre>
	 *
	 * @param inDate1 第一个日期参数 @param inDate2 第二个日期参数 @return 处理结果 0:相等,
	 * -1:inDate1<inDate2, 1:inDate1>inDate2 @throws
	 */
	 ...
	 * 比较两个日期的大小 <p/> <pre> 1、日期参数为空表示无穷小 </pre>
	 *
	 * @param inDate1 第一个日期参数 @param inDate2 第二个日期参数 @param unit 单位 年：1
	 * ;月：2;日：5; 时：10; 分：12;秒：13 @return 处理结果 0:相等, -1:inDate1<inDate2,
	...
	/**
	 * 获取数据库当前时间 根据主机时间与主机时间与系统时间的差值获取统一时间
	 *
	 * @return 数据库时间
	 */
	...
	// try {
	// baseDao = (IBaseDao)
	// LocalContextFactory.getInstance().getBean("baseDao");
	// } catch (Exception e) {
	 ...
	 * @throws ParseException
	 */
	public static Date toDateYmdHmsWthS(String dateStr) throws ParseException {
		return (new SimpleDateFormat("yyyy/MM/dd HH:mm:ss")).parse(dateStr);
	}
